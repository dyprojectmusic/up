...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`Usage: node TZyox.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
const tips1 =[
"DDOS SEDANG DI BERJALAN",
"Stop learning is the same as giving up"
];
